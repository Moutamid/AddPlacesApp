...
//                }
//                ArrayAdapter<String> adapter = new ArrayAdapter<>(AddPlacesActivity.this, android.R.layout.simple_spinner_item, lastmodels);
...
////                        Log.d("AddPlacesActivity", "Selected category: " + category);  // Add this line for logging
////                        Toast.makeText(AddPlacesActivity.this, "Selected category: " + category, Toast.LENGTH_SHORT).show();
...
//                        Log.d("AddPlacesActivity", "Nothing selected");  // Add this line for logging
//                    }
//                });
//
//            }
